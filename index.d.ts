...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a logistic distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( mu: number, s: number, options?: Options );
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating pseudorandom numbers drawn from a logistic distribution.
	*/
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( mu: number, s: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( mu: number, s: number, options?: Options ): RandomStream; // callable
	...
	* }
	*/
	factory( mu: number, s: number, options?: Options ): ( ...args: Array<any> ) => RandomStream; // tslint:disable-line: max-line-length
	...
	* }
	*/
	factory( options?: Options ): ( mu: number, s: number ) => RandomStream;

	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a logistic distribution.
	*
	* @param mu - mean
	* @param s - scale parameter
	* @param options - stream options
	...
	*/
	objectMode( mu: number, s: number, options?: Options ): RandomStream;
}
