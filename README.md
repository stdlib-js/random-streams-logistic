...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-logistic@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-logistic/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-logistic@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-logistic/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-logistic@umd/browser.js"></script>
```
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from a [logistic][logistic] distribution with parameters `mu` (mean) and `s` (scale).
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-logistic.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-logistic

[test-image]: https://github.com/stdlib-js/random-streams-logistic/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-streams-logistic/actions/workflows/test.yml?query=branch:v0.2.2
...
[cli-section]: https://github.com/stdlib-js/random-streams-logistic#cli
[cli-url]: https://github.com/stdlib-js/random-streams-logistic/tree/cli
[@stdlib/random-streams-logistic]: https://github.com/stdlib-js/random-streams-logistic/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-logistic/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-logistic/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-logistic/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-logistic/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-logistic/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-logistic/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-logistic/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-logistic/main/LICENSE
